  ...
  return (
    <Card style={{ width: "100vw", height: "100%" }}>
      {props.chosen.lat || props.chosen.long ? (
        <Map locationLat={props.chosen.lat} locationLong={props.chosen.long} />
      ) : null}
      <CardContent>
        ...
        <Typography component="div" style={{ fontWeight: 600, fontSize: 16 }}>
          Start:
          <Box fontWeight="light" display="inline" sx={{ fontSize: 14 }}>
            {" " + props.chosen.start}
          </Box>
        </Typography>
        <Typography component="div" style={{ fontWeight: 600, fontSize: 16 }}>
        ...
        <Typography component="div" style={{ fontWeight: 600, fontSize: 16 }}>
          Details:
          <Box fontWeight="light" display="inline" sx={{ fontSize: 14 }}>
            {" " + props.chosen.AppointmentDetails}
          </Box>
        </Typography>
      </CardContent>
      <CardActions>
        {props.chosen.Pending ? (
          <>
            <Button
              ...
              color="success"
              onClick={() => {
                props.approve(props.chosen.AppDetailsID);
              }}
            >
              Approve
            </Button>
            <Button
              ...
              color="error"
              onClick={() => {
                props.decline(props.chosen.AppDetailsID);
              }}
            >
              Decline
            </Button>
