      ...
      return (
         ...
         <form className={classes.root} onSubmit={(e)=>{handleSubmit(e)}}>
             <Grid container spacing={2}>
                 <Grid item xs={12} >
                 <Typography variant="subtitle2" component="h2">Rate Babysitter: </Typography>
                 <Rating name="half-rating" value={rating}  onChange={(event, newValue) => {setrating(newValue);}} precision={1} />
